...
m3l_1x1_xyr_centerFZ/b4_reuse_n11_xyr_cFZ_intr2_250goon"
...
python "${WORK_DIR}"/train.py \
  ...
  --if_training=1 \
    --log_steps=200 \
    --save_interval_secs=5200 \
    --save_summaries_secs=5200 \
...
--min_scale_factor=0.8 \
  ...
  --dataset_dir="/mrtstorage/users/zwang/pcd_mapper_pastonly/polar_2f_xyr_intr2/train" \
--tf_initial_checkpoint="/mrtstorage/users/zwang/github_zheyuan/share_files/checkpoints/reuse_struct/baser1_train_350k/model.ckpt-350000"
  ...
  #--tf_initial_checkpoint="/mrtstorage/users/zwang/github_zheyuan/mrt_experiments/m3l_1x1_xyr_centerFZ/b4_reuse_n11_xyr_cFZ_intr2_350k/train/model.ckpt-250000"
