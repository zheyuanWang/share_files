...
m3l_1x1_xyr_centerFZ/b4_reuse_n11_xyr_cFZ_intr12_OR1x1convx3_fullmask"
...
CUDA_VISIBLE_DEVICES=3 python "${WORK_DIR}"/train.py \
  --logtostderr \
  --train_split="train" \
...
--min_scale_factor=0.8 \
  ...
  --tf_initial_checkpoint="/mrtstorage/users/zwang/github_zheyuan/share_files/checkpoints/reuse_struct/b4_reuse_n11_xyr_cFZ_intr12_IOU4199/model.ckpt-55113"
